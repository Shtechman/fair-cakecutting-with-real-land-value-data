...
class AlgorithmSimpleAssessor:
	...
	def __init__(self, assessorAgentPool):
		"""
		@param assessorAgentPool a pool of equal-eval agents representing the assessor
		"""

		self.assessorAgentPool = assessorAgentPool
		# hor_slices = 2^ceil(log2(n)/2)
		# ver_slices = 2^floor(log2(n)/2)
	...
	def getAlgorithmType(self):
		return "{}_{}".format("Assessor", "Simple")
